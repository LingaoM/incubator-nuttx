                              ...
                              nuttx_socklen_t *addrlen)
{
  ...
  if (src_addr && addrlen)
    {
      sockaddr_to_nuttx((struct sockaddr *)&naddr, naddrlen, src_addr,
                        addrlen);
    }
                             ...
                             nuttx_socklen_t *addrlen)
{
  ...
  if (addr && addrlen)
    {
      ret = sockaddr_to_nuttx((struct sockaddr *)&naddr, naddrlen, addr,
                              addrlen);
    }
                        ...
                        nuttx_socklen_t *addrlen)
{
  ...
  if (addr && addrlen)
    {
      sockaddr_to_nuttx((struct sockaddr *)&naddr, naddrlen, addr, addrlen);
    }
